<template>
  <section class="py-6 my-28 sm:py-12 dark:bg-gray-800 dark:text-gray-100">
    <div class="container p-6 mx-auto space-y-8">
      <div class="space-y-2 text-center">
        <h2 class="p-4 text-4xl font-semibold leadi text-center">
          Meilleures "recettes retard" de la semaine !
        </h2>
        <p class="font-serif text-sm dark:text-gray-400">
          Découvrez les 4 recettes de nos chefs retard de la semaine !
        </p>
      </div>
      <div
